vga_write   cp 0x80000060 num0      //vga_command = 0	
...
wait	    bne wait 0x80000061 num1 	// branch if vga_response is one
vga_return	ret ret_address


vga_read            cp 0x80000060 num0      //vga_command = 0	
			        cp 0x80000063 x1 		// vga_x1 = x1
			        //cp 0x80000065 x2 		// vga_x2 = x2
